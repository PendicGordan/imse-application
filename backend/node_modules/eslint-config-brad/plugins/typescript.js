...
const disabledBaseRules = Object.keys(eslint_plugin_1.default.configs.all).reduce((acc, rule) => {
...
exports.default = {
    ...
    rules: Object.assign(rules, disabledBaseRules, eslint_plugin_1.default.configs['eslint-base']),
};
